...
O jogador deve responder a perguntas que simulam problemas logísticos e estratégicos, escolhendo a **estrutura de dados** ou o **algoritmo** mais adequado para cada situação. Eficiência é a chave para a sobrevivência.

### Objetivo Principal

Transformar o aprendizado de temas complexos e abstratos em uma **experiência dinâmica e interativa**.  
Ao invés de apenas memorizar conceitos, o jogador os **aplica em um contexto narrativo**, reforçando a importância e a utilidade prática de cada algoritmo.
